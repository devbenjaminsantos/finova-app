...
export const translations = {
  "pt-BR": {
    ...
    accounts: {
      ...
      syncSuccessFallback: "Sincronização executada para {{institution}} - {{account}}.",
      sincronizaçãoError: "Não foi possível sincronizar esta conta.",
      removeConfirm:
