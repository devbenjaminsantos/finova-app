...
- [ ] Validar testes do frontend e API, build de produção e Docker.
- [ ] Publicar o commit no repositório atual.
- [ ] Renomear o repositório para `hestia-app` e atualizar o remote local.
